				 	...
				 	<form role="form" method="post" autocomplete="off">
				 		...
				 		<div class="inputArea">
					  	...
					  	<div class="inputArea">
							...
							<p>
								<input type="text" name="userAddrZip" id="sample2_address" placeholder="주소"><br>
								<input type="text" name="userAddr" id="sample2_detailAddress" placeholder="상세주소">
								<input type="text" name="userAddrDetail" id="sample2_extraAddress" placeholder="참고항목">
							</p>
